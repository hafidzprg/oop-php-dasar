...
echo"<hr/>";
echo"<h3 style='margin-left: 5rem;'>Data Properti Kayu</h3>";
              ...
              <tbody>
                ...
                $i = 1;
                 foreach ($properti1 as $kayu) {
                    echo "<tr>
                        <td>$i</td>
                        <td>{$kayu->namaProperti}</td>
                        <td>{$kayu->jenisProperti}</td>
              ...
              <tbody>
                ...
                $i = 1;
                 foreach ($properti2 as $bahan) {
                    echo "<tr>
                        <td>$i</td>
                        <td>{$bahan->namaProperti}</td>
                        <td>{$bahan->jenisProperti}</td>
